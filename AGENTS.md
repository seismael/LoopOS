...
- **Task Execution:** When operating LoopOS, always pick the first `[ ]` task in `PLANS.md`, change it to `[/]`, execute the work using your native capabilities, and mark it `[x]` upon completion.
